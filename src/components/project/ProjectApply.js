...
const TS_LIST = [
  { id: null, value: "기술 스택" },
  { id: "T0", value: "Java" },
  { id: "T1", value: "Javascipt" },
  { id: "T2", value: "Spring" },
  { id: "T3", value: "HTML/CSS" },
  { id: "T4", value: "jQuery" },
  { id: "T5", value: "JSP" },
  { id: "T6", value: "Vue.js" },
  { id: "T7", value: "Oracle" },
  { id: "T8", value: "MySQL" },
  { id: "T9", value: "React" },
  { id: "T10", value: "Spring Boot" },
  { id: "T11", value: "PHP" },
  { id: "T12", value: "Python" },
  { id: "T13", value: "Node.js" },
  { id: "T14", value: "C#" },
  { id: "T15", value: "Swift" },
  { id: "T16", value: "전자정부 프레임워크" },
  { id: "T17", value: "Kotlin" },
  { id: "T18", value: "MSSQL" },
  { id: "T19", value: "React Native" },
];

// const aname_REGEX = /^[ㄱ-ㅎ|가-힣|A-z0-9-_]{4,23}$/;
...
const ProjectApply = () => {
  ...
  const [selectedDropTs, setSelectedDropTs] = useState("");
  ...
  const handleDropTs = (e) => {
    const { value } = e.target;
    setSelectedDropTs(TS_LIST.filter((el) => el.value === value)[0].id);
  };

  // const handleSubmit = async (e) => {
  //     e.preventDefault();

  //     const v1 = aname_REGEX.test(aname);
  ...
  //             JSON.stringify({ aname, pfield, preg }),
  //             {
        ...
        <section>
          ...
          <div className="sm:text-center lg:text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline mb-10">프로젝트 지원</span>
            </h1>
          </div>
          <form
          ...
          >
            ...
            <div className="block text-grey-darker text-lg font-bold text-center mb-3">
              프로젝트명 : project.name
              <br />
              지원자 : username
            </div>
            ...
            {/* 
                        <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="username">
                            * 프로젝트명 :
                            <FontAwesomeIcon icon={faCheck} className={validAname ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validAname || !aname ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="aname"
                            ...
                            value={aname}
                            required
                            aria-invalid={validAname ? "false" : "true"}
                            aria-describedby="uidnote"
                            onFocus={() => setAnameFocus(true)}
                            onBlur={() => setAnameFocus(false)}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" />
                        <p id="uidnote" className={anameFocus && aname && !validAname ? "instructions" : "offscreen"}>
            ...
            <ProductBar>
              ...
              <ShowingCode>{selectedDropTs}</ShowingCode>
            </ProductBar>

            <div className="mb-6"></div>
            <div className="flex items-center justify-between">
              {/* <button disabled={!validAname || !validPreg || !validPfield ? true : false} */}
              {/* <button disabled={!validAname ? true : false} */}
              ...
              <a
                ...
                href="#"
              >
                <Link to="../project/recruit"> 다른 프로젝트 보기 </Link>
              </a>
            </div>
          </form>
        </section>
...
//<button disabled={!validAname || !validPhc || !validPfield || !validPreg ? true : false}
